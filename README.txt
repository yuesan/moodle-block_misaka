...
* Rename the misaka/ folder to the name of your module (eg "widget").
...
all the instances of the string "misaka" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/misaka/widget/g' {} \;

* Rename the file lang/en/misaka.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_misaka.php
...
and you should find that this misaka has been added to the list of
installed modules.
